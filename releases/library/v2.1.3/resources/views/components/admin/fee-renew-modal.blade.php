        ...
        <form @submit.prevent="submitRenew()" class="space-y-4 p-5">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="date" x-model="renewForm.joining_date" @change="onRenewOptionsChanged()" @input="onRenewOptionsChanged()" required class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm">
                </div>
