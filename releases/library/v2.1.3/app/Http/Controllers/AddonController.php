...
use App\Services\Addons\AddonPackageInstaller;
...
class AddonController extends Controller
{
    public function upload(Request $request, AddonPackageInstaller $installer, AddonRegistry $addons): JsonResponse
    {
        ...
        $slug = $installer->installUploadedPackage($validated['package']);
        $addons->install($slug);

        $this->logActivity($request, 'addons.installed', "Installed addon {$slug} from upload.");
