...
class ProfitLossController extends Controller
{
    ...
    public function store(StoreExpenseRequest $request, ProfitLossService $profitLossService): JsonResponse
    {
        ...
        $expense = Expense::query()->create([
            ...
            'expense_date' => $this->resolveExpenseDate($request),
    ...
    private function resolveExpenseDate(Request $request): Carbon
    {
        $tz = config('libcontrol.timezone', 'Asia/Kolkata');

        if ($request->filled('expense_date')) {
            return Carbon::parse($request->string('expense_date'), $tz)->startOfDay();
        }
