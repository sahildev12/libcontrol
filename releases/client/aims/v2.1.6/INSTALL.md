...
- `LibControl-aims-v2.1.6.zip` â€” upload to hosting (document root = extracted app folder; root `.htaccess` routes to `public/`)
- `LibControl-aims-v2.1.6.sql` â€” phpMyAdmin import
