<x-admin-layout>
    <div
        x-data="studentOffersPage({
            ...
            sendUrl: @js(route('promotion.send')),
    ...
    >
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">Send promotional emails to students{{ $scopeLabel !== '' ? ' for '.$scopeLabel : '' }}.</p>
        </header>

        @if (! $offersEnabled)
            <div class="mt-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-950">
                Promotion emails are turned off.
        ...
        @elseif ($viewingAll)
            <div class="mt-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-950">
                Select a specific branch from the top bar to send promotion emails.
            </div>
        @endif
                ...
                <form class="mt-4 space-y-4" @submit.prevent="sendOffers">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            maxlength="5000"
                            class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm"
                            placeholder="Write your promotion details here..."
                        ></textarea>
                    ...
                    <div class="flex justify-end">
                        ...
                        >
                            <span x-show="! sending">Send promotion email</span>
