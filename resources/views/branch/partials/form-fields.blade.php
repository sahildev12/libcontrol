<div class="grid gap-4 sm:grid-cols-2">
    ...
    <div>
        ...
        <input
            ...
            class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm"
        >
        <p class="mt-1 text-xs text-gray-500">10-digit Indian mobile number.</p>
    </div>
    <div class="sm:col-span-2">
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700">Login email <span class="text-red-500">*</span></label>
        <input
            type="email"
            x-model="{{ $mode === 'create' ? 'createForm.login_email' : 'editForm.login_email' }}"
            required
